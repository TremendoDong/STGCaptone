...
model = load_model('/Users/tremendo/Desktop/ST Ass3/TremendoDong_u3249826_keras_model.h5')
# Load the labels
label_path='/Users/tremendo/Desktop/ST Ass3/TremendoDong_u3249826_labels.txt'
class_names = open(label_path, "r").readlines()

test_image_path = '/Users/tremendo/Desktop/ST Ass3/Human Action Recognition/test/Image_2.jpg'
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

#initialize GUI
top=tk.Tk()
top.geometry('800x600')
top.title('Human Actions Recognition Image Classification')
...
heading = Label(top, text="Human Actions Recognition Image Classifier",pady=20, font=('arial',20,'bold'))
